    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<List<ProductoDTO>> Lista()
        {
            try
            {
                ...
                var listaProductos = queryProducto.Include(cat=>cat.TipoNavigation).ToList();
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                productoEncontrado.Sku = productoModelo.Sku;
                productoEncontrado.Tipo = productoModelo.Tipo;
                productoEncontrado.Precio = productoModelo.Precio;
                productoEncontrado.Etiquetas = productoModelo.Etiquetas;
